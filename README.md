...
|---|---|
| Prompts utilizados por participante/questão | [`AIConnection/README.md`](./AIConnection#prompts-utilizados) |
...
| Configuração e resultados do SonarQube (IA vs. especialista) | [`GeneratedCodeByAI/README.md`](./GeneratedCodeByAI#resultados-do-sonarqube) |
| Código de referência do especialista | [`ReferenceCode/`](./ReferenceCode) |
| Datasets normalizados e resultados do CodeBLEU | [`CodeBleuPreprocessor/README.md`](./CodeBleuPreprocessor#resultados-do-codebleu) |
